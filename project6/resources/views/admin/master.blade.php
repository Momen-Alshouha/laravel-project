                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="basic-table.html"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Approved Mentors</span>
                            </a>
                        </li>
...
{{--&copy;Mentor Hub. All Rights Reserved. Designed by 
        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <footer class="footer text-center"> <p><span style="color: orange;" >Mentor Hub</span> &copy; All Rights Reserved. Designed by 
            <span style="color: orange;" > Mentor Hub Team </span></p>
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
