...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
                ...
                <nav class="sidebar-nav" style="padding-top: 15%;">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-4 mb-4">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/dashboard" aria-expanded="false" style="font-size: 20px;">
                        ...
                        <li class="sidebar-item mb-4">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin_profile" aria-expanded="false" style="font-size: 20px;">
                        ...
                        <li class="sidebar-item mb-4">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/mentors" aria-expanded="false" style="font-size: 20px;">
                        ...
                        <li class="sidebar-item mb-4">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/category" aria-expanded="false" style="font-size: 20px;">
        ...
        <footer class="footer text-center">
            <p style="margin-left: 10%;"><span style="color: orange;">Mentor Hub</span> &copy; All Rights Reserved. Designed by
